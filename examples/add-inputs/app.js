...
var _behavior = require('../../src/behavior');
...
var addInputs = function addInputs(elx, ely, container) {
  var x = (0, _behavior.map)(Number, (0, _dom.inputValue)(elx));
  var y = (0, _behavior.map)(Number, (0, _dom.inputValue)(ely));
  var z = (0, _behavior.liftA2)(add, x, y);

  var inputEvents = (0, _domEvent.input)(container);

  return (0, _behavior.sample)(z, inputEvents);
};
...
addInputs(byId('x'), byId('y'), byId('container')).observe(render);

},{"../../src/behavior":70,"../../src/dom":71,"@most/dom-event":2}],2:[function(require,module,exports){
...
exports.await_       = promises.awaitPromises;
 ...
 */
Stream.prototype.await_ = function() {
...
exports.sample = exports.ap = exports.liftA2 = exports.map = exports.constant = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /** @license MIT License (c) copyright 2016 original author or authors */
...
var map = exports.map = (0, _prelude.curry2)(function (f, behavior) {
...
var liftA2 = exports.liftA2 = (0, _prelude.curry3)(function (f, b1, b2) {
  return new LiftA2(f, b1, b2);
});
var ap = exports.ap = (0, _prelude.curry2)(function (bf, bx) {
  return new LiftA2(apply, bf, bx);
});
var apply = function apply(f, x) {
  return f(x);
};
...
var sample = exports.sample = (0, _prelude.curry2)(function (behavior, stream) {
  return stream.loop(stepSample, behavior);
});

var stepSample = function stepSample(behavior, _ref) {
  var time = _ref.time;
  var value = _ref.value;
  return { seed: behavior, value: behavior.value(time) };
};

},{"@most/prelude":4}],71:[function(require,module,exports){
'use strict';
